...
import TimeLinePhoto from '../../../assets/Images/TimelineImage.png'
            ...
            <div className='flex flex-col lg:flex-row gap-20 mb-20 items-center'>
                ...
                >
                    ...
                    <div className='relative shadow-light-blue-200 dark:shadow-dark-blue-200'>
                        <img src={TimeLinePhoto} alt="timeLineImage" className=' shadow-white object-cover h-fit shadow-[20px_20px_0px_0px_#FFFFFF]' />
