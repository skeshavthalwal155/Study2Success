        ...
        <div>
            <div className='flex-1 overflow-auto py-10'>
                <div className='mx-auto w-11/12 max-w-maxContent'>
                    ...
                    {/* Delete Account */}
                    <div className='my-10 flex flex-row gap-x-5 rounded-md border-[1px]dark:border-dark-pink-700 border-light-pink-700 dark:bg-dark-pink-900 bg-red-200 md:p-8 md:px-12'>
