    ...
    <div>
      ...
      <form onSubmit={handleOnSubmit} className="flex w-full flex-col gap-y-4">
        <div className="flex gap-x-4">
          <label>
          <p className='mb-1 text-[0.875rem] leading-[1.375rem] text-light-richblack-5 dark:text-dark-richblack-5'>First Name<sup className='text-red-500 dark:text-dark-pink-200'>*</sup></p>
            <input
              required
              type="text"
              name="firstName"
          ...
          <label>
          <p className='mb-1 text-[0.875rem] leading-[1.375rem] text-light-richblack-5 dark:text-dark-richblack-5'>Last Name<sup className='text-red-500 dark:text-dark-pink-200'>*</sup></p>
            <input
              required
              type="text"
              name="lastName"
        ...
        <div className="flex gap-x-4">
          ...
          <label className="relative">
          <p className='mb-1 text-[0.875rem] leading-[1.375rem] text-light-richblack-5 dark:text-dark-richblack-5'>Confirm Password<sup className='text-red-500 dark:text-dark-pink-200'>*</sup></p>
