...
const SideBar = () => {
  ...
  return (
    <div className='flex h-[calc(100vh-3.5rem)] min-w-[220px] flex-col border-r-[1px] dark:bg-dark-richblack-800 dark:border-dark-richblack-700 border-light-richblack-700 bg-light-richblack-800 py-10 '>
