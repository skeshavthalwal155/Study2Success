...
const VideoDetailsSidebar = ({ setReviewModal }) => {
    ...
    return (
        <>
     <div className='flex h-[calc(100vh-3.5rem)] md:w-[320px]  max-w-[350px] flex-col border-r-[1px] border-r-light-richblack-800 dark:border-r-dark-richblack-800 dark:bg-dark-richblack-800 bg-light-richblack-800'>
