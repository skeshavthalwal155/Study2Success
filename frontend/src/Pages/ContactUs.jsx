...
const ContactUs = () => {
    return (
        <div>
            {/* Form */}
            <div className='mx-auto mt-20 flex w-11/12 max-w-max flex-col justify-between gap-10 dark:text-dark-richblack-5 text-light-richblack-5 lg:flex-row '>
                <div className='lg:w-[40%]'>
                    <div className='flex flex-col gap-6 rounded-xl bg-light-richblack-800 dark:bg-dark-richblack-800'>
                        <div className='flex gap-4 p-3 text-sm text-light-richblack-200 dark:text-dark-richblack-200'>
                            <div>
                            ...
                            <div>
                                <h1 className='text-lg font-semibold text-light-richblack-5 dark:text-dark-richblack-5'>Chat on Us</h1>
                                <p className='font-medium'>Our Friendly team is here to help.</p>
                                <p className='font-semibold'>info.study2succes@gmail.com</p>
                            </div>
                        </div>
                        <div className='flex gap-4 p-3 text-sm text-light-richblack-200 dark:text-dark-richblack-200'>
                            <div>
                            ...
                            <div>
                            <h1 className='text-lg font-semibold text-light-richblack-5 dark:text-dark-richblack-5'>Visit Us</h1>
                                <p className='font-medium'>Come and say hello at our office HQ.</p>
                                <p className='font-semibold'>Near Sanskar Srijan School, ward no 10, Dhalwala, Munikireti, Tehri Garhwal, Uttarakhand - 249137</p>
                            </div>
                        </div>
                        <div className='flex gap-4 p-3 text-sm text-light-richblack-200 dark:text-dark-richblack-200'>
                            <div>
                            ...
                            <div>
                            <h1 className='text-lg font-semibold text-light-richblack-5 dark:text-dark-richblack-5'>Call Us</h1>
                ...
                <div className='lg:w-[60%]'>
                    <div className='border border-light-richblack-600 dark:border-dark-richblack-600 text-light-richblack-300 dark:text-dark-richblack-300 rounded-xl p-7 lg:p-14 flex gap-3 flex-col'>
                        <h1 className='text-4xl leading-10 font-semibold text-light-richblack-5 dark:text-dark-richblack-5'>Got a Idea? We've Got the skills. Let's team up</h1>
