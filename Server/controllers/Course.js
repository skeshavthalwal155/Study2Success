...
exports.createCourse = async (req, res) => {
    try {
        ...
        // console.log("Thubnmail = " ,thumbnail)
        // console.log("Request files:", req.files); // Common typo to check
        // console.log("Request file:", req.file); // Single file upload
        // console.log("Request body:", req.body); // Other form data
